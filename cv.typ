...
events: (
  [Architected and implemented core features, refactored legacy code, mentored new developers, one of two core core maintainers on #link("https://zarf.dev")[Zarf]: a tool to package cloud native applications and deployments. DevSecOps for the air gap.],
